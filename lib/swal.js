...
export function swalDefault(title, text, icon, extraOptions = {}) {
  ...
  if ("optionsConstant" in extraOptions) {
    const { optionsConstant, ...finalExtraOptions } = extraOptions;
    extraOptions = finalExtraOptions;
  }
...
export function swalSuccess(title, text, extraOptions = {}) {
  return swalDefault(title, text, "success", extraOptions);
}

export function swalInfo(title, text, extraOptions = {}) {
  return swalDefault(title, text, "info", extraOptions);
}
