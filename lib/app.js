      ...
      <div class="space-y-2 border-t border-brand-border py-2">
        ...
        <div class="flex items-center gap-x-4 w-full justify-between">
          ...
          <div class="w-full">
            ...
            <p class="w-full text-base font-mono text-green-900 tracking-wider">${patient.no_telpon ?? "-"}</p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-x-4 w-full justify-between">
          ...
          <div class="w-full">
            ...
            <p class="w-full text-base font-mono text-green-900 tracking-wider">${patient.ketAktif} &mdash; FASKES: ${patient.kdProviderPst.nmProvider}</p>
          </div>
        </div>
...
async function selectPoliInner(index) {
  ...
  if (responseAtrean.status) {
    ...
    🪧 <b>Kepesertaan</b> : ${state.kepesertaan.ketAktif} - ${state.kepesertaan.kdProviderPst.nmProvider}
    🏝️ <b>Satu Wilayah?</b> : ${isFaskesPalu ? "Ya" : "Tidak"}
    🩺 <b>Poli</b> : ${state.poli.nama_pemeriksaan} (${state.poli.nama_dokter})
    `;
