...
export const API_BASE_ENDPOINT = "https://api-v3.medikaconnect.com/v1";
...
export const LoginApi = async () => {
  ...
  await fetch("https://api-v3.medikaconnect.com/v1/auth/login/", {
    method: "POST",
...
export const CheckNik = async (nik) => {
  ...
  let resJson = null;
  try {
    const res = await fetch(`${API_BASE_ENDPOINT}/pasien/nik/${nik}`, {
      method: "GET",
      headers: theHeaders,
    });
